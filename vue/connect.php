                    ...
                    <div class="panel-body">
                        <div class="box box-info">
                            <div class="box-body">
                                ...
                                <div class="col-sm-5 col-xs-6 tital " >Votre nom d'utilisateur:</div><div class="col-sm-7 col-xs-6 "><?php echo $_SESSION['login']?></div>
                                <div class="clearfix"></div>
                                <div class="bot-border"></div>

                                <div class="col-sm-5 col-xs-6 tital " >Votre nom:</div><div class="col-sm-7"><?php echo $_SESSION['nom']?></div>
                                <div class="clearfix"></div>
                                <div class="bot-border"></div>

                                <div class="col-sm-5 col-xs-6 tital " >Votre prénom:</div><div class="col-sm-7"><?php echo $_SESSION['prenom']?></div>
                                <div class="clearfix"></div>
                                <div class="bot-border"></div>

                                <div class="col-sm-5 col-xs-6 tital " >Votre adresse mail:</div><div class="col-sm-7"><?php echo $_SESSION['mail']?></div>

                                <div class="clearfix"></div>
                                <div class="bot-border"></div>

                                <div class="col-sm-5 col-xs-6 tital " >Votre classe:</div><div class="col-sm-7"><?php echo $_SESSION['classe']?></div>

                                <!--<div class="clearfix"></div>
                                    <div class="bot-border"></div>

                                    <div class="col-sm-5 col-xs-6 tital " >Compte crée depuis:</div><div class="col-sm-7"><?php echo $_SESSION['login']?></div>-->

                                <div class="clearfix"></div>
                                <div class="bot-border"></div>

                                <div class="col-sm-5 col-xs-6 tital " >Votre rang:</div><div class="col-sm-7">
                                    <?php
                                    if($_SESSION['rang'] == 0){
                                        echo 'En attente.<br>';
                                    }
